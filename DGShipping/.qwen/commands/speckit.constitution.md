...
1. Run `C:\Users\g.shubham\AppData\Roaming\uv\tools\specify-cli\Scripts\python.exe .specify/scripts/python/resolve_template.py constitution-template --json` from the repository root and parse `TEMPLATE_CONTENT` as the active template.
